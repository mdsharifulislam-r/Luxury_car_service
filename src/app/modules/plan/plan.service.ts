...
import { Plan as Subscription } from "./plan.model";
...
const updatePlanToDB = async(data:Partial<IPlan>,id:Types.ObjectId)=>{
...
const deleteProduct = async (product_id:Types.ObjectId)=>{
  ...
  return await Subscription.findOneAndUpdate({_id:product_id},{status:"delete"},{new:true})
}
...
const managePlans = async (customerId: string)=>{
